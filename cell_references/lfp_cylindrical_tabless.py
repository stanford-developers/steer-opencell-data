...
cell_name = "LFP Cylindrical Tabless Cell"
...
# %%
_plot_exporter.save(
    cathode_active_material.plot_specific_capacity_curve(),
    'plot_specific_capacity_curve',
)
# %%
# Create the anode
...
cell = ocd.CylindricalCell(
    ...
    operating_voltage_window=(2.0, 3.65),
    name=cell_name
)
# %%
_plot_exporter.save(
...
# %%
cell.reversible_capacity_range
# %%
