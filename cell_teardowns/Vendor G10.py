...
# %%
_plot_exporter.save(
    cell.plot_mass_breakdown(height=800, width=800),
    'plot_mass_breakdown',
)
# %%
_plot_exporter.save(
    cell.plot_cost_breakdown(height=800, width=800),
    'plot_cost_breakdown',
)
# %%
_plot_exporter.save(
...
# %%
print("Specific energy: ", cell.specific_energy)
print("Volumetric energy: ", cell.volumetric_energy)
print("Specific Cost: ", cell.cost_per_energy)
# %%
import pandas as pd
