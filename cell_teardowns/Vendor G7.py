...
cathode_active_material.irreversible_specific_capacity = 110
...
anode_active_material.irreversible_specific_capacity = 280
...
cell = ocd.CylindricalCell(
    ...
    operating_voltage_window= (1.5, 3.8),
